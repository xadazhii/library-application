...
**Library Application** is a modern application that allows:  
- **Users** to easily manage their book collections and transactions.  
- **Administrators** to oversee users, books, and borrowing transactions.  

The program provides a user-friendly interface to access personal dashboards, libraries, collections, and more.
...
- Open the cloned project in an integrated development environment (IDE), such as IntelliJ IDEA.

3. Before running the application, ensure that you have the following installed:
- **Java 17** or higher
...
4. Run the project:
- To start the server:
Navigate to the server module in your IDE and run the ServerMain class.
- To start the client:
Navigate to the client module in your IDE and run the ClientMain class.

---

## **Copyrights**

This project uses free icons and images from **Flaticon**.  
You can find more icons and resources at [Flaticon](https://www.flaticon.com/free-icons).

Background images were sourced from **Pinterest**.  
You can explore more images on [Pinterest](https://www.pinterest.com).

All icons and images are located in the **Resource Package**.
